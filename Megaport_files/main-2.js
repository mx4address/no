...
function init() {
  ...
  // gameover messages
  var msgsSelf = [];
  msgsSelf[0] = "you shared a love with a newegg power supply";
  msgsSelf[1] = "ryzen7 ftw!";
  msgsSelf[2] = "now you must fuck angel"; 
  msgsSelf[3] = "now you must fuck dropto:rage:";  
  
  var msgsWall = [];
  msgsWall[0] = "itteh you are a scammer";
  msgsWall[1] = "remember to visit my site or else";
  msgsWall[2] = "FOOT CAM";
  msgsWall[3] = "angel sus :sus:";
  msgsWall[4] = "this is a certified hood classic";
  ...
  reset = function() {
    ...
    function gameover() {
      ...
      tweet.href='https://youtu.be/SnJFs_6wFQE?t=6';
